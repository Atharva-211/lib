...
static const char *const yytname[] =
{
  ...
  "$accept", "input", "assignment", "expr", "term", "factor", YY_NULLPTR
};
...
{
     -10,     0,   -10,   -10,    -4,    -2,     4,     5,    13,   -10,
      -2,   -10,     7,   -10,    -2,    -2,   -10,    -2,    -2,    17,
     -10,    13,    13,   -10,   -10
};
...
{
       4,     0,     1,    12,    13,     0,     0,     0,     8,    11,
       0,    13,     0,     3,     0,     0,     2,     0,     0,     5,
      14,     6,     7,     9,    10
};
...
{
       2,     3,    11,     3,     4,    21,    22,     5,    10,     5,
      14,    15,    14,    15,    12,    13,    16,    20,     0,    19,
      17,    18,    14,    15,     0,    23,    24
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     3,     4,    14,    15,     9,    12,     9,
       5,     6,     5,     6,     5,    11,    11,    10,    -1,    10,
       7,     8,     5,     6,    -1,    17,    18
};
...
#line 1089 "exp.tab.c"
  ...
  case 5: /* assignment: VARIABLE '=' expr  */
#line 35 "exp.y"
                      {
        sym[(yyvsp[-2].var) - 'a'] = (yyvsp[0].num);
        initialized[(yyvsp[-2].var) - 'a'] = 1;
        printf("%c = %d\n", (yyvsp[-2].var), (yyvsp[0].num));
    }
#line 1099 "exp.tab.c"
    break;
...
#line 63 "exp.y"
             {
        if (!initialized[(yyvsp[0].var) - 'a']) {
            char msg[50];
            snprintf(msg, sizeof(msg), "Variable '%c' not initialized", (yyvsp[0].var));
            yyerror(msg);
            (yyval.num) = 0;
        } else {
            (yyval.num) = sym[(yyvsp[0].var) - 'a'];
        }
    }
#line 1163 "exp.tab.c"
    break;
